const acordeonRightFormUp = require('./components/acordeonRightFormUp.js');
acordeonRightFormUp();
...
const workSectionAccordeon = require('./components/workSectionAccordeon.js');
workSectionAccordeon();

const projectSectionAccordeon = require('./components/projectSectionAccordeon.js');
projectSectionAccordeon();

const materialSectionAccordeon = require('./components/materialSectionAccordeon.js');
materialSectionAccordeon();

const rehabSectionAccordeon = require('./components/rehabSectionAccordeon.js');
rehabSectionAccordeon();

const materialPopup = require('./components/materialPopup.js');
materialPopup();
